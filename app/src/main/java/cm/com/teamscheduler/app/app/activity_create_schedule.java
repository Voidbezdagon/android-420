            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.schedule_view:
                        startActivity(new Intent(activity_create_schedule.this,activity_schedule.class));
                        break;
                    ...
                    case R.id.location_view:
                        ...
                        break;
                    case R.id.team_view:
                        startActivity(new Intent(activity_create_schedule.this, activity_team.class));
                        break;
                }
