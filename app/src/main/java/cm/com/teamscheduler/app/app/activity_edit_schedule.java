    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.user_list_view:
                        startActivity(new Intent(activity_edit_schedule.this, activity_user.class));
                        break;
                    case R.id.calendar_view:
                        startActivity(new Intent(activity_edit_schedule.this,scheduleCalendar.class));
                        break;
                    case R.id.schedule_view:
                        startActivity(new Intent(activity_edit_schedule.this,activity_schedule.class));
                        break;
                    case R.id.positions_view:
                        startActivity(new Intent(activity_edit_schedule.this, activity_position.class));
                        break;
                    case R.id.location_view:
                        startActivity(new Intent(activity_edit_schedule.this, activity_location.class));
                        break;
                    case R.id.team_view:
                        startActivity(new Intent(activity_edit_schedule.this, activity_team.class));
                        break;
                }
        ...
        iv.setOnClickListener(new ImageView.OnClickListener(){
            ...
            public void onClick(View view) {
                startActivity(new Intent(activity_edit_schedule.this, activity_edit_logged_user.class));
            }
        });
        //END OF MENU
        ...
        save.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                try
                {
                    js.put("id", getIntent().getLongExtra("scheduleId", 0));
                    EditText st = (EditText) findViewById(R.id.scheduleFormTitle);
                ...
                JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                        ...
                        new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                Intent i = new Intent(activity_edit_schedule.this, activity_schedule.class);
                                startActivity(i);
                            }
                        }, new Response.ErrorListener() {
                    @Override
